                            ...
                            <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg border-0" style="background-image: url('/image/${image.id}/preview'); min-height: 350px;">
                                <div class="d-flex flex-column h-100 text-dark">
                                    ...
                                    <ul class="d-flex list-unstyled mt-auto bg-light px-4 py-2 mb-0">
                                        <li class="me-auto">
                                            <small><strong>Kategori</strong>: ${(image.category.name)!"Okategoriserat"}</small><br />
                                            <small><strong>Fotograf</strong>: <#if image.photographer??>${(image.photographer.givenName)!"Förnamn"} ${(image.photographer.familyName)!"Efternamn"}<#else>Ej angiven</#if></small><br />
                    ...
                    <div class="accordion accordion-flush mb-4" id="accordionFlushExample">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    <p>Raderar uppladdningen och alla dess bilder. <strong>Handlingen går inte att ångra.</strong></p>
                                    <form action="/upload/${upload.id}/delete" method="post">
                                        <button class="btn btn-outline-danger rounded-4 w-100" type="submit">Radera uppladdning</button>
                                    </form>
                                </div>
                            </div>
                        </div>
